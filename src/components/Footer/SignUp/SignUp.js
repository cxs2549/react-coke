...
const SignUp = () => {
	return (
		<StyledSignUp className="flex flex-col items-center justify-center py-6 gap-y-6 border-b border-gray-800">
            ...
            <button className="text-xl font-bold text-white bg-red-500 px-8 py-3 rounded-full hover:bg-white hover:text-red-500 transition-colors duration-300">Sign Up</button>
		</StyledSignUp>
	)
}
